...
export const aboutContent = {
  ...
  description:
    "EduReach College is a premier engineering and technology institution established in 2005, located in Chennai, Tamil Nadu. Affiliated with Anna University and approved by AICTE, New Delhi, our 25-acre campus features smart classrooms, advanced laboratories, and a central library with 50,000+ books.",
  highlights: [
